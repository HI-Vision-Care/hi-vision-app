...
export default function FullScreenChatBot({ onBack }: FullScreenChatBotProps) {
    ...
    const [accountId, setAccountId] = useState<string>() // Moved inside component

    const scrollViewRef = useRef<ScrollView>(null)

    // Initialize account ID from token
    useEffect(() => {
        const initializeAccountId = async () => {
            try {
                ...
                console.warn("Invalid token or error reading from storage:", error)
            }
        }
                ...
                <View style={styles.chatContent}>
                    {messages.length === 0 ? (
                        ...
                        <View style={styles.welcomeContainer}>
                            <LinearGradient colors={["#EFF6FF", "#F3E8FF"]} style={styles.welcomeBackground}>
                                <View style={styles.welcomeContent}>
                                    <LinearGradient colors={["#2563EB", "#8B5CF6", "#EC4899"]} style={styles.welcomeIconContainer}>
                                    ...
                                    <Text style={styles.welcomeSubtitle}>Tôi có thể giúp gì cho bạn hôm nay?</Text>
                                </View>
                ...
                <View style={styles.inputContainer}>
                    ...
                    {prompt.trim() && (
                        ...
                        >
                            ...
                            >
                                <Text style={styles.sendButtonText}>{loading ? "Đang gửi..." : "Gửi"}</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    )}
                </View>
