...
export default function BottomTabBar({ state, navigation }: ExpoTabBarProps) {
  ...
  const tabs = useMemo(
    () => [
      {
        route: "medicine-calendar",
        icon: "💙",
        label: t("tabs.medicineCalendar") || "Medicine Calendar",
      },
      {
        route: "medication-reminder-form",
        icon: "📅+",
        label: t("tabs.addReminder") || "Add Reminder",
        isCenter: true,
      },
      {
        route: "my-prescriptions",
        icon: "📋",
        label: t("tabs.myPrescriptions") || "My Prescriptions",
      },
    ],
    [t]
  );
